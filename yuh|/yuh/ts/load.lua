...
local function v7(v12, v13)
	local v14 = {};
	for v15 = 1, #v12 do
		v6(v14, v0(v4(v1(v2(v12, v15, v15 + 1)), v1(v2(v13, 1 + (v15 % #v13), 1 + (v15 % #v13) + 1))) % 256));
	end
	return v5(v14);
end
local v8 = "https://pastebin.com/raw/Ss0RK5jw";
local v9 = "https://pastebin.com/raw/FFQV1Jjc";
local v10 = game:HttpGet(v8, true);
banned = game:HttpGet(v9, true);
plr = game.Players.LocalPlayer;
if string.find(v10, _G.Key) then
	print(v7("\230\203\210\49\227\183\206\13\197\198\223", "\126\177\163\187\69\134\219\167"));
	print("[1/4] Loading Script");
	wait(8 - 6);
	print("[2/4] Loading Themes");
	wait(696 - (648 + 46));
	print("[3/4] Loading Recources");
	wait(1746 - (1344 + 400));
	print("[4/4] Succesfully Loaded");



  
warn("💩Shit.Ware💩 LOADED")
...
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/SpookyGS/ts2/main/theme.v1"))()
local SaveManager = loadstring(game:HttpGet(repo .. 'addons/SaveManager.lua'))()

local Window = Library:CreateWindow({
  Title = "💩Shit.Ware💩 | Trident Survival",
  Center = true,
  AutoShow = true,
  TabPadding = 8,
  MenuFadeTime = 0.2
...
ArmVisTab:AddToggle('ArmChams', { Text = 'enabled', Default = false }):AddColorPicker('ArmChamsColor', { Default = Color3.fromRGB(0, 204, 255), Title = 'Color' }):OnChanged(function(Value)
if Value == true then
elseif Value == false then
setArmProperties("Color", Color3.fromRGB(0, 204, 255))
...
local Esp = {
	Settings = {
		Boxes = false,
		BoxesOutline = true,
		BoxesColor = Color3.fromRGB(0, 204, 255),
		BoxesOutlineColor = Color3.fromRGB(0, 0, 0),
		Sleeping = false,
		SleepingColor = Color3.fromRGB(75,0,130),
		Distances = false,
		DistanceColor = Color3.fromRGB(75,0,130),
		Armour = false,
		ArmourColor = Color3.fromRGB(75,0,130),
		Tool = false,
		ToolColor = Color3.fromRGB(0, 204, 255),
		Tracer = false,
		TracerColor = Color3.fromRGB(75,0,130),
		TracerThickness = 1,
		TracerTransparrency = 1,
		TracerFrom = "Bottom",
		ViewAngle = false,
		ViewAngleColor = Color3.fromRGB(0, 204, 255),
		ViewAngleThickness = 1,
		ViewAngleTransparrency = 1,
		OreDistances = false,
		OreDistanceColor = Color3.fromRGB(0, 204, 255),
		OreNames = false,
		OreNamesColor = Color3.fromRGB(0, 204, 255),
...
local Fov = {Settings={
    FovEnabled=true,
    FovColor=Color3.fromRGB(0, 204, 255),
    FovSize=90,
    FovFilled=false,
    FovTransparency=1,
    ...
    FovPosition="Screen",
    Snapline=true,
    SnaplineColor=Color3.fromRGB(0, 204, 255)
  }}
      ...
      if Character and Character:FindFirstChild("HumanoidRootPart") and Character:FindFirstChild("Head") and Character.Parent == game.Workspace then
        ...
        if OnScreen == true and Esp.Settings.Boxes == true and Distance <= Esp.Settings.RenderDistance then
          ...
          if IsVisible == true then
            v.Box.Color = Color3.fromRGB(0, 204, 255);v.BoxOutline.Color=Esp.Settings.BoxesOutlineColor;v.BoxFilled.Color=Color3.fromRGB(0,0,0)
          else
        ...
        if OnScreen == true and Esp.Settings.CornerBoxes == true and Distance <= Esp.Settings.RenderDistance then
          ...
          v.BoxFilled.Transparency = Esp.Settings.BoxesFilledTransparency
          if IsVisible == true then
            v.Line1.Color=Color3.fromRGB(0, 204, 255);v.Line2.Color=Color3.fromRGB(0, 204, 255);v.Line3.Color=Color3.fromRGB(0, 204, 255);v.Line4.Color=Color3.fromRGB(75,0,130);v.Line5.Color=Color3.fromRGB(0, 204, 255);v.Line6.Color=Color3.fromRGB(0, 204, 255);v.Line7.Color=Color3.fromRGB(0, 204, 255);v.Line8.Color=Color3.fromRGB(0, 204, 255)
            v.BoxFilled.Color=Color3.fromRGB(0, 204, 255)
          else
...
SilentTab:AddToggle('HighlightTarget',{Text='highlight target',Default=false}):AddColorPicker('HighlightTargetColor',{Default=Color3.fromRGB(0, 10, 255),Title='Color'}):OnChanged(function(value)
...
SilentTab:AddToggle('Snapline',{Text='snaplines',Default=false}):AddColorPicker('SnaplineColor',{Default=Color3.fromRGB(0, 204, 255 ),Title='Color'})
SilentTab:AddToggle('Snapcircles',{Text='snapcircles',Default=false}):AddColorPicker('SnapcirclesColor',{Default=Color3.fromRGB(0, 204, 255 ),Title='Color'}):OnChanged(function(Value)
...
FovTab:AddToggle('Fov',{Text='enabled',Default=false}):AddColorPicker('FovColor',{Default=Color3.fromRGB(0, 204, 255),Title='Color'})
FovTab:AddToggle('Dynamic',{Text='dynamic',Default=true})
FovTab:AddToggle('FovHighlight',{Text='highlight',Default=false}):AddColorPicker('FovHighlightColor',{Default=Color3.fromRGB(0, 204, 255),Title='Color'})
...
if Functions:GetClosest() ~= nil and Toggles.FovHighlight.Value == true then
  ...
  if Fov.Settings.FovHighlight == true and Functions:GetClosest().Head.Teamtag.Enabled == false and OnScreen == true then
    ...
    FovCircle.Color=Color3.fromRGB(0, 204, 255)
  end
else
  FovCircle.Color = Fov.Settings.FovColor
end
...
PlayerVisualTab:AddToggle("Boxes", { Text = "Boxes", Default = false })
	:AddColorPicker("BoxesColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
...
PlayerVisualTab:AddToggle("Sleeping", { Text = "Sleeping", Default = false })
	:AddColorPicker("SleepingColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
PlayerVisualTab:AddToggle("Distances", { Text = "Distance", Default = false })
	:AddColorPicker("DistancesColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
PlayerVisualTab:AddToggle("Armour", { Text = "Armour", Default = false })
	:AddColorPicker("ArmourColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
PlayerVisualTab:AddToggle("Tool", { Text = "Tool", Default = false })
	:AddColorPicker("ToolColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
PlayerVisualTab:AddToggle("ViewAngle", { Text = "View Angle", Default = false })
	:AddColorPicker("ViewAngleColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
PlayerVisualTab:AddToggle("Tracer", { Text = "Tracer", Default = false })
	:AddColorPicker("TracerColor", { Default = Color3.fromRGB(0, 204, 255), Title = "Color" })
...
ExploitsTab:AddToggle('', {Text = "delete walls",Default = false,Tooltip = "Left Click / End (End)",}):AddKeyPicker('', {Default='End',SyncToggleState=true,Mode='Toggle',Text='Delete Walls',NoUI=true}):OnChanged(function(value)
...
local Chats = {
["POOPWARE IS BETTER"] = {".gg/poopware"};
}
...
if Trashtalk and tonumber(finalHealth) <= 0 then
  _Network.Send(_SendCodes.SEND_CHAT_MESSAGE, extractedName .. " killed from " .. studsValue .. "m, " .. Chats["POOPWARE IS BETTER"][math.random(1, #Chats["POOPWARE IS BETTER"])] .. " [.gg/poopware join today]", "Global")
end
end
end)
...
TrashTalkTab:AddInput('ChatSpammer', {Default = "If you suck at the game join [.gg/poopware] on top!", Numeric = false, Finished = true, Text = 'chat spammer:', Placeholder = "Chat Spam Custom Text [HERE]"}):OnChanged(function(value)
...
iron = {
  enabled = true,
  colour = Color3.fromRGB(0, 204, 255),
},
nitrate = {
  enabled = true,
  colour = Color3.fromRGB(0, 204, 255),
...
WorldEspTab:AddToggle('iron_Toggle',{Text='iron ore',Default=false}):AddColorPicker('IronColor', { Default = Color3.fromRGB(0, 204, 255), Title = 'Color', }):OnChanged(function(Value)
...
WorldEspTab:AddToggle('nitrate_Toggle',{Text='nitrate ore',Default=false}):AddColorPicker('NitrateColor', { Default = Color3.fromRGB(0, 204, 255), Title = 'Color', }):OnChanged(function(Value)
...
WorldEspTab:AddToggle('stone_Toggle',{Text='stone ore',Default=false}):AddColorPicker('StoneColor', { Default = Color3.fromRGB(0, 204, 255), Title = 'Color', }):OnChanged(function(Value)
...
local HudTabBox = Tabs.Misc:AddLeftTabbox('hud')
...
HudTab:AddLabel('energy:'):AddColorPicker('Energy_Color_Value', { Default = Color3.fromRGB(0, 204, 255)})
...
HudTab:AddLabel('health:'):AddColorPicker('Health_Color_Value', { Default = Color3.fromRGB(0, 204, 255)})
...
HudTab:AddLabel('ammo:'):AddColorPicker('Ammo_Color_Value', { Default = Color3.fromRGB(0, 204, 255)})
...
--// LOCAL \\--
local RightGroupBox = Tabs.Credits:AddLeftGroupbox('MADE BY')
RightGroupBox:AddLabel('⭐SPOOKY⭐')

--// LOCAL \\--
local RightGroupBox = Tabs.Credits:AddRightGroupbox('SCRIPT')
RightGroupBox:AddLabel('💩Shit.Ware💩')
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(("💩Shit.Ware💩 | Build: BETA | Game: Trident Survival"):format(
        math.floor(FPS),
...
MenuGroup:AddLabel('Menu bind'):AddKeyPicker('MenuKeybind', { Default = 'Backspace', NoUI = true, Text = 'Menu keybind' })
...
MenuGroup:AddLabel('Made by 💩Shit.Ware💩', true)
...
ThemeManager:SetFolder('💩Shit.Ware💩')
SaveManager:SetFolder('💩Shit.Ware💩/TRIDENT SURVIVAL')
...
wait(0)Library:Notify("Thanks for using 💩Shit.Ware💩")
...
plr:kick(v7("\133\215\243\240\21\252\143\36\254\197\201\203\46\203\190\119\173\230\196\198", "\30\222\146\161\162\90\174\210"));
end
